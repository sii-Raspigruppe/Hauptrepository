...
def html_write():
    try:
        htmlget = 'https://simpletab.de/motionscout/count.php?user=udo&wert1=Raspi V1.3.2'
        x = requests.get(htmlget)
        print(htmlget," -> ",x.status_code)
    except:
        print("Error: HTTP GET fehlgeschlagen")
